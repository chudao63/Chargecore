    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text('${app.cab} · Khóa ${app.lock}', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
            Text('SN ${app.sn} · KTV ${app.tech}', style: const TextStyle(fontSize: 12, color: AppColors.muted)),
          ],
        ),
